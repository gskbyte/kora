...
public class UsersActivity extends ProfilesActivity
{
    ...
    public void updateListView()
    {
        ...
        Collection<User> customUsers = (Collection<User>) ProfilesManager.getCustomUsers();
        ...
        if(mAdapter.getSectionIndex(defaultsSectionName) == -1){
            ...
            Collection<User> defaultUsers = (Collection<User>) ProfilesManager.getDefaultUsers();
