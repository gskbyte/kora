...
public class ProcComm
{
	...
	public String read(final Datapoint dp)
    {
        try {
            String r = pc.read(dp);
            System.out.println("read ("+dp.toString()+") = " + r);
            return r;
        }
        catch (final KNXException e) {
            System.out.println("KNXException read: " + e.getMessage());
        }
        catch (final KNXIllegalArgumentException e) {
            System.out.println("KNXIllegalArgumentException read: "+ e.getMessage());
        }
        
        return null;
    }
	
    public void write(final Datapoint dp, final String value)
    {
        try {
            pc.write(dp, value);
        }
        catch (final KNXException e) {
            System.out.println("KNXException write");
        }
    }
}
