...
public class DeviceSelectionActivity extends Activity
{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        KoraButton w = new KoraButton(this, "Heater", R.drawable.icon_device_heater_128),
                   w2 = new KoraButton(this, "Light", R.drawable.icon_device_light_128),
                   w3 = new KoraButton(this, "Music", R.drawable.icon_device_music_128),
                   w4 = new KoraButton(this, "Sunblind", R.drawable.icon_device_sunblind_128),
                   w5 = new KoraButton(this, "Light", R.drawable.icon_device_light_128);
